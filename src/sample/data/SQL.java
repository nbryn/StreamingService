...
public class SQL {
    ...
    public void initializeH2(){
        String tableInitQuerry = "" +
                ...
                ")";
        String movieInitQuerry = "INSERT INTO movies(name,release,genre,rating) VALUES" +
        ...
        String seriesInitQuerry = "INSERT INTO series (name,span,genre,rating,seasons)"+
                ...
                "('Smallville', '2001-2011', 'Adventure, Drama, Romance', '7,5', '1-21, 2-23, 3-22, 4-22, 5-22, 6-22, 7-20, 8-22, 9-21', '19-22'),"+
        ...
        String usersInitQuerry = "INSERT INTO users (username,password) VALUE ('TEST','SUPPE'";
